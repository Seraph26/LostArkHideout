...
function specFor(p){const enl=norm((p?.enlightenment||[]).join(' '));const e=enl||text(p);const rules=[
 ...
 [/predator/,'Predator'],[/punisher/,'Punisher'],[/deathblow/,'Deathblow'],[/esoteric flurry/,'Esoteric Flurry'],[/first intention/,'First Intention'],[/esoteric skill enhancement/,'Esoteric Skill Enhancement'],[/asura.?s path/,"Asura's Path"],[/brawl king storm/,'Brawl King Storm'],[/dreadful roar/,'Dreadful Roar'],[/evolutionary legacy/,'Evolutionary Legacy'],[/arthetinean/,'Arthetinean Skill'],
