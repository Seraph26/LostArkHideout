...
function encounterFromOption(o){return o?{id:o.value,label:o.textContent,boss:o.dataset.boss,difficulty:o.dataset.difficulty,schema:o.dataset.schema,gate:o.dataset.gate?Number(o.dataset.gate):null,sourceGroup:o.dataset.sourceGroup,kind:o.dataset.kind}:null}
function fallback(){return{updatedAt:null,source:'fallback',raids:[
{id:'horizon-cathedral-g1',label:'Horizon Cathedral — Gate 1',boss:'Horizon Cathedral Gate 1',kind:'raid',schema:'level'},
{id:'horizon-cathedral-g2',label:'Horizon Cathedral — Gate 2',boss:'Horizon Cathedral Gate 2',kind:'raid',schema:'level'},
...
{id:'extreme-aegir-g2',label:'[EXTREME] Aegir — Gate 2',boss:'Extreme Aegir Gate 2',kind:'event',schema:'extreme'},
{id:'extreme-brelshaza-g2',label:'[EXTREME] Brelshaza — Gate 2',boss:'Extreme Brelshaza Gate 2',kind:'event',schema:'extreme'}
]}}
