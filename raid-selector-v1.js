/* Lost Ark Hideout — raid selector manifest integration v4 */
(()=>{
'use strict';
...
{id:'horizon-cathedral-g1',label:'Horizon Cathedral — Gate 1',boss:'Horizon Cathedral Gate 1',kind:'raid'},
{id:'horizon-cathedral-g2',label:'Horizon Cathedral — Gate 2',boss:'Horizon Cathedral Gate 2',kind:'raid'},
